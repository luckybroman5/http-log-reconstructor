...
To see the current plan for the next release, check out [this milestone](https://github.com/luckybroman5/http-log-reconstructor/k6/milestone/4), which we aim to make the v1.0 release!

Have a look at [our roadmap](https://github.com/luckybroman5/http-log-reconstructor/k6/wiki/Roadmap) for what's up ahead, beyond the v1.0 release.
