...
<p align="center">
  <a href="https://github.com/luckybroman5/http-log-reconstructor/k6/releases"><img src="https://img.shields.io/github/release/loadimpact/k6.svg" alt="Github release"></a>
  ...
  <a href="https://goreportcard.com/report/github.com/luckybroman5/http-log-reconstructor/k6"><img src="https://goreportcard.com/badge/github.com/luckybroman5/http-log-reconstructor/k6" alt="Go Report Card"></a>
...
<p align="center">
    <a href="https://github.com/luckybroman5/http-log-reconstructor/k6/releases">Download</a> ·
...
- [**Cloud execution**](https://docs.k6.io/docs/cloud-execution) and distributed tests _(currently only on infrastructure managed by [Load Impact](https://loadimpact.com/), with native distributed execution in k6 [planned](https://github.com/luckybroman5/http-log-reconstructor/k6/wiki/Roadmap) for the near future!)_
...
If there isn't an official package for your operating system or architecture, or if you don't want to install a custom repository, you can easily grab a pre-built binary from [the GitHub Releases page](https://github.com/luckybroman5/http-log-reconstructor/k6/releases). Once you download and unpack the release, you can optionally copy the `k6` binary it contains somewhere in your `PATH`, so you are able to run k6 from any location on your system.
...
- Run `go get github.com/luckybroman5/http-log-reconstructor/k6` which will:
  - git clone the repo and put the source in `$GOPATH/src/github.com/luckybroman5/http-log-reconstructor/k6`
...
In some situations it may also be useful to execute remote scripts. You can do that with HTTP**S** URLs in k6 by [importing them](https://docs.k6.io/docs/modules#section-remote-modules) in the script via their URL or simply specifying their URL in the CLI command: `k6 run github.com/luckybroman5/http-log-reconstructor/k6/samples/http_2.js` (k6 "knows" a bit about github and cdnjs URLs, so this command is actually shorthand for `k6 run raw.githubusercontent.com/loadimpact/k6/master/samples/http_2.js`)
...
This means that if your script works when it's executed with `k6 run` locally, it should also work without any modifications in a distributed execution environment like `k6 cloud` (that executes it in the Load Impact cloud infrastructure) or, in the future, with the [planned](https://github.com/luckybroman5/http-log-reconstructor/k6/wiki/Roadmap) k6 native cluster execution mode.
...
You can save the above example as a local file and run it, or you can also run it directly from the [github copy of the file](https://github.com/luckybroman5/http-log-reconstructor/k6/blob/master/samples/thresholds_readme_example.js) with the `k6 run github.com/luckybroman5/http-log-reconstructor/k6/samples/thresholds_readme_example.js` command. You can find (and contribute!) more k6 script examples here: [https://github.com/luckybroman5/http-log-reconstructor/k6/tree/master/samples](https://github.com/luckybroman5/http-log-reconstructor/k6/tree/master/samples)
...
- I got this error and I'm sure it's a bug -- [file an issue](https://github.com/luckybroman5/http-log-reconstructor/k6/issues)
- I have an idea/request -- [file an issue](https://github.com/luckybroman5/http-log-reconstructor/k6/issues)
...
If you want to contribute or help with the development of k6, start by reading [CONTRIBUTING.md](https://github.com/luckybroman5/http-log-reconstructor/k6/blob/master/CONTRIBUTING.md). Before you start coding, especially when it comes to big changes and features, it might be a good idea to first discuss your plans and implementation details with the k6 maintainers. You can do this either in the [github issue](https://github.com/luckybroman5/http-log-reconstructor/k6/issues) for the problem you're solving (create one if it doesn't exist) or in the `#developers` channel on [Slack](https://k6.io/slack).
