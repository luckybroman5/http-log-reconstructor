...
```bash
go get github.com/luckybroman5/http-log-reconstructor/k6
```
This will also build a `k6` binary and put it in `$GOPATH/bin`.

**Building from source**:

Standing in the repo root (`$GOPATH/src/github.com/luckybroman5/http-log-reconstructor/k6`) you can build a k6 binary from source by running:
```bash
cd $GOPATH/src/github.com/luckybroman5/http-log-reconstructor/k6
go build
```
...
```bash
go test -race github.com/luckybroman5/http-log-reconstructor/k6/core
```
...
```bash
go test -race github.com/luckybroman5/http-log-reconstructor/k6/core -run ^TestEngineRun$
```
