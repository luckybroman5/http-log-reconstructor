...
import (
	...
	"github.com/luckybroman5/http-log-reconstructor/k6/lib/netext"
	"github.com/luckybroman5/http-log-reconstructor/k6/lib/netext/httpext"
...
func TestNewName(t *testing.T) {
	...
	cases := []struct {
		...
		{
			url: &url.URL{
				Opaque: "github.com/luckybroman5/http-log-reconstructor/k6/samples/http_get.js",
			},
			expected: "http_get.js",
		},
		{
			url:      mustParse("http://github.com/luckybroman5/http-log-reconstructor/k6/samples/http_get.js"),
			expected: "http_get.js",
		},
		{
