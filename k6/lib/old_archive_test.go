...
import (
	...
	"github.com/luckybroman5/http-log-reconstructor/k6/lib/fsext"
	"github.com/luckybroman5/http-log-reconstructor/k6/lib/scheduler"
...
func TestOldArchive(t *testing.T) {
	var testCases = map[string]string{
		...
		"github.com/luckybroman5/http-log-reconstructor/k6/samples/example.js": `github file`,
	...
	for filename, data := range testCases {
		...
		t.Run(filename, func(t *testing.T) {
			...
			fs := makeMemMapFs(t, map[string][]byte{
				// files
				"/files/github.com/luckybroman5/http-log-reconstructor/k6/samples/example.js": []byte(`github file`),
				...
				// scripts
				"/scripts/github.com/luckybroman5/http-log-reconstructor/k6/samples/example.js2": []byte(`github script`),
			...
			var (
				expectedFilesystems = map[string]afero.Fs{
					...
					"https": makeMemMapFs(t, map[string][]byte{
						...
						"/github.com/luckybroman5/http-log-reconstructor/k6/samples/example.js":  []byte(`github file`),
						"/cdnjs.com/packages/Faker":                     []byte(`faker file`),
						"/github.com/luckybroman5/http-log-reconstructor/k6/samples/example.js2": []byte(`github script`),
...
func TestFilenamePwdResolve(t *testing.T) {
	var tests = []struct {
		...
		{
			Filename:            "github.com/luckybroman5/http-log-reconstructor/k6/samples/http2.js",
			Pwd:                 "github.com/luckybroman5/http-log-reconstructor/k6/samples",
			expectedFilenameURL: &url.URL{Opaque: "github.com/luckybroman5/http-log-reconstructor/k6/samples/http2.js"},
			expectedPwdURL:      &url.URL{Opaque: "github.com/luckybroman5/http-log-reconstructor/k6/samples"},
		},
		{
